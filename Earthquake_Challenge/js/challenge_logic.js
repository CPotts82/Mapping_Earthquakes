...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(majorData) {
    ...
    // This function returns the style data on map.
   ...
   // to calculate the color and radius.
    ...
    //  after the marker has been created and styled.
    L.geoJson(majorData, {
      // Turn each major quake into circle Marker
      pointToLayer: function(feature, latlng) {
        console.log(majorData);
        return L.circleMarker(latlng);
      },
      style: styleMajor,
      // Create popup for circle to display magnitude and location of earthquake
      onEachFeature: function(feature, layer) {
        layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
      }
    }).addTo(majorQuakes);
